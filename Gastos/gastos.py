from PyQt5.QtWidgets import QInputDialog,QLineEdit,QMessageBox, QLabel, QVBoxLayout, QWidget, QComboBox
    ...
    def insertData(self):
        ...
        if category and ok:
            ...
            if description and ok and monto and ok1 and details and ok2:
                ...
                query = f"INSERT INTO public.gastos (descripcion, monto, categoria,detalles) VALUES ('{description}',{int(monto)},'{category}','{details}')"
