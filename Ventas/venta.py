...
class Venta(Ventana):
    ...
    def insertData(self): 
        ...
        phone, ok1 = QInputDialog.getDouble(self,'Realizar Venta','Inserta el teléfono del cliente',QLineEdit.Normal,0)
        ...
        if ok  and ok1  and ok2:
            ...
            query1 = f'''SELECT id FROM clientes WHERE nombre = '{client}' '''
